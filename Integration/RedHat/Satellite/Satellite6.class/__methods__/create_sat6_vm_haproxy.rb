...
$evm.log(:info, "----------------------Begin Create_Sat6_VM_HAProxy-------------------------")
...
scid = getlkid("haproxywp","hostname_wordpress0")
scu = {
  "match" => "fqdn=#{fqdn}",
  "value" => hostname_wordpress0,
  "use_puppet_default" => false
}
post_json($url+"smart_class_parameters/#{scid}/override_values", scu.to_json)

scid = getlkid("haproxywp","hostname_wordpress1")
scu = {
  "match" => "fqdn=#{fqdn}",
  "value" => hostname_wordpress1,
  "use_puppet_default" => false
}
post_json($url+"smart_class_parameters/#{scid}/override_values", scu.to_json)

scid = getlkid("haproxywp","ipaddress_wordpress0")
scu = {
  "match" => "fqdn=#{fqdn}",
  "value" => hostname_wordpress0,
  "use_puppet_default" => false
...
scid = getlkid("haproxywp","ipaddress_wordpress1")
scu = {
  "match" => "fqdn=#{fqdn}",
  "value" => hostname_wordpress1,
  "use_puppet_default" => false
